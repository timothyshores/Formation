...
console.log("");
console.log("Test cases using approach 2 should all return true");
console.log("--------------------------------------------------");
console.log(!wordsCancelItself2("no"));
console.log(!wordsCancelItself2("what"));
console.log(!wordsCancelItself2("no what"));
console.log(wordsCancelItself2("what what"));
console.log(!wordsCancelItself2("what no what"));
console.log(wordsCancelItself2("what what no no"));
console.log(wordsCancelItself2("no no what what"));
console.log(!wordsCancelItself2("what what what"));
console.log(!wordsCancelItself2("what no no what"));
console.log(!wordsCancelItself2("what no no what"));
console.log(wordsCancelItself2("what what what what"));
console.log(wordsCancelItself2("what what no no yes yes"));
console.log(!wordsCancelItself2("what what what what what"));
console.log(wordsCancelItself2("what what what what what what"));
