...
console.log(sumNestedListWithDepth([1, [1, 1]]) === 5);
console.log(sumNestedListWithDepth([1, [2, 3]]) === 11);
console.log(sumNestedListWithDepth([4, [2, 3]]) === 14);
console.log(sumNestedListWithDepth([1, [1, 1], 1]) === 6);
console.log(sumNestedListWithDepth([1, [2, [3]]]) === 23);
console.log(sumNestedListWithDepth([4, [2, [3]]]) === 26);
console.log(sumNestedListWithDepth([1, [1, 2, 3], 3]) === 16);
console.log(sumNestedListWithDepth([1, [1, [1], 1], 1]) === 12);
console.log(sumNestedListWithDepth([1, [1, [1, 1], 1], 1]) === 18);
